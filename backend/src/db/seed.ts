...
for (const p of people) {
  ...
  `).run({ ...p, user_id: userId, created_at: now });
}
...
const tasks = [
  ...
  },
  {
    ...
    duration: 60, pomos_done: 0, pomos_total: 3, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
  ...
  },
  {
    ...
    quadrant: "Q1", today: 1, due: now.slice(0, 10),
    duration: 20, pomos_done: 0, pomos_total: 1, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: null, not_now_json: "[]",
  },
  {
    ...
    duration: 180, pomos_done: 0, pomos_total: 6, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
  ...
  },
  {
    ...
    duration: 15, pomos_done: 0, pomos_total: 1, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: null, not_now_json: "[]",
  },
  {
  ...
  },
  {
    ...
    duration: 45, pomos_done: 0, pomos_total: 2, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: "Q2", not_now_json: "[]",
  },
  {
    ...
    desc_en: null, desc_zh: null,
    quadrant: "unclassified", today: 0, due: null,
    duration: 40, pomos_done: 0, pomos_total: 2, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
  ...
  },
  {
    ...
    duration: 5, pomos_done: 0, pomos_total: 1, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: null, not_now_json: "[]",
  },
  {
    ...
    desc_en: null, desc_zh: null,
    quadrant: "Q2", today: 0, due: null,
    duration: 25, pomos_done: 0, pomos_total: 1, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: null, not_now_json: "[]",
  },
  {
    ...
    desc_en: null, desc_zh: null,
    quadrant: "Q4", today: 0, due: null,
    duration: 10, pomos_done: 0, pomos_total: 1, conviction: null,
    next_step_en: null, next_step_zh: null, reason_en: null, reason_zh: null,
    ai_suggest: null, not_now_json: "[]",
  },
];
...
for (const t of tasks) {
  insertTask.run({ ...t, user_id: userId, created_at: now, updated_at: now });
}
...
const completed = [
  {
    id: "c1",
    title_en: "Reply to design feedback from Pieter", title_zh: "回复 Pieter 的设计反馈",
    duration: 18, quadrant: "Q2",
    started_at: todayAt(8, 55), completed_at: todayAt(9, 13),
  },
  {
    id: "c2",
    title_en: "Set up next week's calendar blocks", title_zh: "排好下周的日程块",
    duration: 12, quadrant: "Q3",
    started_at: todayAt(9, 20), completed_at: todayAt(9, 32),
  },
  {
    id: "c3",
    title_en: "Review pull request #47", title_zh: "Review PR #47",
    duration: 25, quadrant: "Q1",
    started_at: todayAt(10, 5), completed_at: todayAt(10, 30),
  },
];
...
for (const c of completed) {
  insertCompleted.run({ ...c, user_id: userId, task_id: null });
}
