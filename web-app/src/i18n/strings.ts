...
export const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    "settings.sync.url": "LibSQL / Turso URL",
    "settings.sync.url.placeholder": "libsql://your-db.turso.io",
    "settings.sync.token": "Auth Token",
    "settings.sync.token.placeholder": "Token (leave blank if not required)",
    "settings.sync.save": "Save & Connect",
    "settings.sync.saving": "Connecting…",
    ...
    "settings.sync.helper": "Sync tasks to a remote LibSQL database (Turso). Works across devices.",
    "settings.sync.error.save": "Failed to save remote config",
  ...
  zh: {
    ...
    "settings.sync.url": "LibSQL / Turso 地址",
    "settings.sync.url.placeholder": "libsql://your-db.turso.io",
    "settings.sync.token": "Auth Token",
    "settings.sync.token.placeholder": "令牌（无需认证时留空）",
    "settings.sync.save": "保存并连接",
    "settings.sync.saving": "连接中…",
    ...
    "settings.sync.status.ok": "已连接",
    "settings.sync.status.error": "出错",
    "settings.sync.lastSync": "上次同步",
    "settings.sync.helper": "将任务同步到远程 LibSQL 数据库（Turso），跨设备使用。",
    "settings.sync.error.save": "远程配置保存失败",
