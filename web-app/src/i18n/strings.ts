...
export const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    "settings.sync.title": "Remote Sync",
    "settings.sync.helper": "Connect to a remote Lumo server to keep your data in sync.",
    ...
    "settings.sync.error.save": "Failed to save configuration",
    "settings.sync.error.trigger": "Failed to trigger sync",
    ...
    "habit.freq.weekend": "Weekends",
    "habit.freq.days_of_week": "Custom days",
    "habit.freq.times_per_week": "Times/week",
    "habit.freq.interval": "Every N days",
    "habit.freq.times_per_week.label": "{n} times per week",
    ...
    "habit.day.fri": "Fri",
    "habit.day.sat": "Sat",
    "habit.calendar.title": "Check-in History",
    "habit.calendar.rate": "Completion rate (30d)",
    "habit.calendar.total": "Total check-ins",
    "habit.calendar.checkin": "Check in",
  ...
  zh: {
    ...
    "settings.sync.title": "远程同步",
    "settings.sync.helper": "连接到远程 Lumo 服务器以保持数据同步。",
    ...
    "settings.sync.error.save": "保存配置失败",
    "settings.sync.error.trigger": "触发同步失败",
    ...
    "habit.freq.days_of_week": "自定义",
    "habit.freq.times_per_week": "每周N次",
    "habit.freq.interval": "间隔N天",
    "habit.freq.times_per_week.label": "每周 {n} 次",
    "habit.freq.interval.label": "每隔 {n} 天",
    "habit.day.sun": "日",
    "habit.day.mon": "一",
    "habit.day.tue": "二",
    "habit.day.wed": "三",
    ...
    "habit.day.fri": "五",
    "habit.day.sat": "六",
    "habit.calendar.title": "打卡记录",
    "habit.calendar.rate": "完成率（近30天）",
    "habit.calendar.total": "累计打卡",
    "habit.calendar.checkin": "打卡",
